			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Zarządzaj rezerwacjami</h2>
...
if($result->Status==0)
{
echo htmlentities('Nie potwierdzono');
...
echo htmlentities('Potwierdzono');
 	...
 	echo htmlentities('Anulowano');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Czy napewno chcesz potwierdzic rezerwacje?')"> Potwierdz</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Czy napewno chcesz anulowac rezerwacje?')"> Anuluj</a>
</td>
