			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Zdjecie pojazdu 5 </h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Aktualne zdjecie nr 5</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Dodaj nowe zdjecie nr 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
