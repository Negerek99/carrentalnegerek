			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Zaktualizuj informacje kontaktowe</h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label"> Numer telefonu </label>
												<div class="col-sm-8">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Zaktualizuj</button>
												</div>
											</div>
