			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Zarzadzaj pojazdami</h2>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Jestes pewien ze chcesz usunąć?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
