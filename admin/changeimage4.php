			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Zdjecie pojazdu 4 </h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Aktualne zdjecie nr 4</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Dodaj nowe zdjecie nr 4<span style="color:red">*</span></label>
												<div class="col-sm-8">
