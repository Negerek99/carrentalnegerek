...
$query->execute();
$msg="Zaktulizowano informacje pomylsnie!";
}
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Ustawienia profilu</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>Udało się!</strong>: <?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Data rejestracji: </label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Ostatnia aktualizacja: </label>
            ...
            <div class="form-group">
              <label class="control-label">Data urodzenia&nbsp;(dd/mm/yyyyy)</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Zapisz zmiany <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
