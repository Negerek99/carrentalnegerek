...
$chngpwd1->execute();
$msg="Twoje hasło zostało pomylsnie zmienione!";
}
else {
$error="Twoje obecne hasło jest nieprawidłowe!";  
}
}
...
{
alert("Twoje hasła nie sa takie same!");
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <label class="control-label">Obecne hasło</label>
            ...
            <div class="form-group">
              <label class="control-label">Potwierdz nowe hasło</label>
              <input class="form-control white_bg" id="confirmpassword" type="password" name="confirmpassword"  required>
            </div>
          
            <div class="form-group">
               <input type="submit" value="Zmien hasło" name="update" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
