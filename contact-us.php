...
if($lastInsertId)
{
$msg="Wiadomość została wysłana pomyslnie!";
}
else 
{
$error="Cos poszło nie tak sproboj jeszcze raz";
}
  ...
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        ...
        else if($msg){?><div class="succWrap"><strong>Udało sie!</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Wiadomosc <span>*</span></label>
              <textarea class="form-control white_bg" name="message" rows="4" required></textarea>
            </div>
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">Wyślij wiadomość <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
      <div class="col-md-6">
        <h3>lub skontaktuj sie z nami:</h3>
