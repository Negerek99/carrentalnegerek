    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Moje rezerwacje </h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Od:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Do:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
                <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Potwierdzono</a>
                           <div class="clearfix"></div>
				</div>

              <?php } else if($result->Status==2) { ?>
				<div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Odrzucono</a>
            <div class="clearfix"></div>
				</div>
                ...
                <?php } else { ?>
				<div class="vehicle_status"> <a href="#" class="btn outline btn-xs">W realizacji...</a>
            <div class="clearfix"></div>
				</div>
                <?php } ?>
